<template>
    <mdb-container class="mt-5">
        <mdb-row class="mt-5 align-items-center justify-content-start">
            ...
            <a href="https://mdbootstrap.com/docs/vue/components/jumbotron/?utm_source=DemoApp&utm_medium=MDBVueFree"
            ...
            <section>
                <mdb-card class="card-image"
                    ...
                    <div class="text-white text-center py-5 px-4 my-5">
                        <div>
                            <h2 class="card-title h1-responsive pt-3 mb-5 font-bold"><strong>Create your beautiful
                                website with MDBootstrap</strong></h2>
                            <p class="mx-5 mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellat
            ...
            <section>
                <mdb-jumbotron class="mb-0 text-center">
                    ...
                    <a class="fa-lg p-2 m-2 li-ic">
                        <mdb-icon fab icon="linkedin-in" class="grey-text"/>
                    </a>
                    <a class="fa-lg p-2 m-2 tw-ic">
                        <mdb-icon fab icon="twitter" class="grey-text"/>
                    </a>
                    <a class="fa-lg p-2 m-2 fb-ic">
                        <mdb-icon fab icon="facebook-f" class="grey-text"/>
                    </a>
                </mdb-jumbotron>
            </section>
        </section>
                ...
                <mdb-jumbotron class="mb-0 text-center">
                    ...
                    <mdb-row class="d-flex justify-content-center">
                        <mdb-col xl="7" class="pb-2">
                            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fuga aliquid
                                dolorem ea distinctio exercitationem delectus qui, quas eum architecto, amet quasi
                                accusantium, fugit consequatur ducimus obcaecati numquam molestias hic itaque
                ...
                <mdb-card class="card-image"
                    ...
                    <div class="text-white text-center rgba-stylish-strong py-5 px-4">
                        <div class="py-5">
                            ...
                            <p class="mb-4 pb-2 px-md-5 mx-md-5">Lorem ipsum dolor sit amet, consectetur adipisicing
                                elit. Pariatur obcaecati vero aliquid libero doloribus ad, unde tempora maiores, ullam,
                                modi qui quidem minima debitis perferendis vitae cumque et quo impedit.</p>
                ...
                <mdb-jumbotron class="mb-0 text-center hoverable p-4">
                    <mdb-row>
                        <mdb-col md="4" offsetMd="1" class="m-3">
                            <mdb-view src="https://mdbootstrap.com/img/Photos/Others/laptop-sm.jpg"
                        ...
                        <mdb-col md="7" class="text-md-left ml-3 mt-3">
                            <a href="#!" class="green-text">
                                <h6 class="h6 pb-1">
                                    <mdb-icon icon="desktop" class="pr-1"/>
                                    Work
                                </h6>
                            </a>
                            <h4 class="h4 mb-4">This is title of the news</h4>
                            <p class="font-weight-normal">Sed ut perspiciatis unde omnis iste natus error sit voluptatem
