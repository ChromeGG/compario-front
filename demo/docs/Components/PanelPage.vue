<template>
    ...
    <mdb-container>
        <mdb-row class="mt-5 align-items-center justify-content-start">
            ...
            <a href="https://mdbootstrap.com/docs/vue/components/panels/?utm_source=DemoApp&utm_medium=MDBVueFree"
            ...
            <mdb-card-group>
                <mdb-card>
                    <mdb-card-body>
                        ...
                        <mdb-card-text>This is a wider panel with supporting text below as a natural lead-in to
                ...
                <mdb-card>
                    <mdb-card-body>
                        <mdb-card-title tag="h5">Panel title</mdb-card-title>
                        <mdb-card-text>This panel has supporting text below as a natural lead-in to additional
                            content.
                        </mdb-card-text>
                        <mdb-card-text small muted>Last updated 3 mins ago</mdb-card-text>
                    </mdb-card-body>
                ...
                <mdb-card>
                    <mdb-card-body>
                        <mdb-card-title tag="h5">Panel title</mdb-card-title>
                        <mdb-card-text>This is a wider panel with supporting text below as a natural lead-in to
                            additional content. This panel has even
            ...
            <mdb-card-group column>
                <mdb-card>
                    <mdb-card-body>
                        ...
                        <mdb-card-text>This is a longer panel with supporting text below as a natural lead-in to
                            additional content. This content is
                            a little bit longer.
                        </mdb-card-text>
                    </mdb-card-body>
