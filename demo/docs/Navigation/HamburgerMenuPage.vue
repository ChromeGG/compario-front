<template>
    <mdb-container>
        <mdb-row class="mt-5 align-items-center justify-content-start">
            ...
            <a href="https://mdbootstrap.com/docs/vue/navigation/hamburger-menu/?utm_source=DemoApp&utm_medium=MDBVueFree"
        ...
        <section class="demo-section">
            ...
            <section>
                <mdb-container>
                    ...
                    <!--/.Navbar-->
                    <!--Navbar-->
                    <mdb-navbar expand="xl" class="mt-2 darken-4" hamburger togglerIcon="chevron-down" togglerSize="xs"
                                dark color="amber">
                        <!-- Navbar brand -->
                        <mdb-navbar-brand class="text-white">Navbar</mdb-navbar-brand>
                        <mdb-navbar-toggler>
