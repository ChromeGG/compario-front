<template>
    <mdb-container>
        <mdb-row class="mt-5 align-items-center justify-content-start">
            ...
            <a href="https://mdbootstrap.com/docs/vue/navigation/footer/?utm_source=DemoApp&utm_medium=MDBVueFree"
...
<script>
    import {mdbCol, mdbContainer, mdbFooter, mdbIcon, mdbRow} from 'mdbvue';
