<template>
    <mdb-container>
        <mdb-row class="mt-5 align-items-center justify-content-start">
            ...
            <a href="https://mdbootstrap.com/docs/vue/navigation/navs/?utm_source=DemoApp&utm_medium=MDBVueFree"
...
<script>
    import {mdbCol, mdbContainer, mdbIcon, mdbNavbar, mdbNavbarNav, mdbNavItem, mdbRow} from 'mdbvue';
