<template>
    <mdb-container>
        <mdb-row class="mt-5 align-items-center justify-content-start">
            ...
            <a href="https://mdbootstrap.com/docs/vue/advanced/popovers/?utm_source=DemoApp&utm_medium=MDBVueFree"
                    ...
                    <mdb-popover trigger="click" :options="{placement: 'bottom'}" :maxWidth="350">
                        <div slot="body">
                            <mdb-jumbotron class="mb-0 p-3 pt-1 text-center">
                                <mdb-view class="my-4" src="https://mdbootstrap.com/img/Photos/Slides/img%20(70).jpg"
                                          alt="">
                                    <a>
