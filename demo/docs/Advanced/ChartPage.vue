<template>
    <mdb-container>
        <mdb-row class="mt-5 align-items-center justify-content-start">
            ...
            <a href="https://mdbootstrap.com/docs/vue/advanced/charts/?utm_source=DemoApp&utm_medium=MDBVueFree"
        ...
        <div class="container">
            ...
            <mdb-horizontal-bar-chart :data="horizontalBarChartData" :options="horizontalBarChartOptions" :width="600"
                                      :height="300"/>
            <hr class="mt-5">
            <h3>Pie Chart</h3>
