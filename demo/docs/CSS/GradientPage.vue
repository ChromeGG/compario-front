<template>
    <mdb-container class="mt-5">
        <mdb-row class="mt-5">
            ...
            <a href="https://mdbootstrap.com/docs/vue/css/gradients/?utm_source=DemoApp&utm_medium=MDBVueFree"
        ...
        <mdb-row>
            ...
            <mdb-col md="6" class="mb-4">
                ...
                <div>
                    <img src="https://mdbootstrap.com/img/Photos/Horizontal/Nature/6-col/img (122).jpg"
                         class="img-fluid" alt="My photo">
                </div>
            </mdb-col>
