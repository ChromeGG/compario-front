<template>
    <mdb-container class="mt-5">
        <mdb-row class="mt-5 align-items-center justify-content-start">
            ...
            <a href="https://mdbootstrap.com/docs/vue/tables/responsive/?utm_source=DemoApp&utm_medium=MDBVueFree"
...
<script>
    import {mdbContainer, mdbIcon, mdbRow, mdbTbl, mdbTblBody, mdbTblHead} from 'mdbvue';
