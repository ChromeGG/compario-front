<template>
    <mdb-container>
        <mdb-row class="mt-5 align-items-center justify-content-start">
            ...
            <a href="https://mdbootstrap.com/docs/vue/advanced/scroll/?utm_source=DemoApp&utm_medium=MDBVuePro"
...
<script>
    import {mdbCard, mdbCardBody, mdbCol, mdbContainer, mdbIcon, mdbRow, mdbScrollbar} from 'mdbvue';
