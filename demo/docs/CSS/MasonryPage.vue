<template>
    <mdb-container>
        <mdb-row class="mt-5 align-items-center justify-content-start">
            ...
            <a href="https://mdbootstrap.com/docs/vue/layout/masonry/?utm_source=DemoApp&utm_medium=MDBVueFree"
               class="border grey-text px-2 border-light rounded ml-2" target="_blank">
        ...
        <section class="demo-section">
            ...
            <section>
                <mdb-masonry flexbox responsive :maxHeight="1200">
                    <mdb-masonry-item src="https://mdbootstrap.com/img/Photos/Others/food3.jpg"
                                      :itemStyle="{'width': '33.4%'}"/>
                    <mdb-masonry-item src="https://mdbootstrap.com/img/Photos/Others/image06.jpg"
                                      :itemStyle="{'width': '33.4%'}"/>
                    <mdb-masonry-item src="https://mdbootstrap.com/img/Photos/Others/image17.jpg"
                                      :itemStyle="{'width': '33.4%'}"/>
                    <mdb-masonry-item src="https://mdbootstrap.com/img/Photos/Others/image02.jpg"
                                      :itemStyle="{'width': '33.3%' }"/>
                    <mdb-masonry-item src="https://mdbootstrap.com/img/Photos/Others/image008.jpg"
                                      :itemStyle="{'width': '33.3%'}"/>
                    <mdb-masonry-item src="https://mdbootstrap.com/img/Photos/Others/image010.jpg"
                                      :itemStyle="{'width': '33.3%'}"/>
                    <mdb-masonry-item src="https://mdbootstrap.com/img/Photos/Others/image002.jpg"
                                      :itemStyle="{'width': '33.3%'}"/>
                    <mdb-masonry-item src="https://mdbootstrap.com/img/Photos/Others/image005.jpg"
                                      :itemStyle="{'width': '33.3%'}"/>
                    <mdb-masonry-item src="https://mdbootstrap.com/img/Photos/Others/image18.jpg"
                                      :itemStyle="{'width': '33.3%'}"/>
                </mdb-masonry>
            </section>
        </section>
                    ...
                    <mdb-masonry-item :itemStyle="{'width': '45%', 'padding': '10px'}">
                        <mdb-card>
                            <mdb-card-body>
                                ...
                                <mdb-card-text>Some quick example text to build on the panel title and make up the bulk
                    ...
                    <mdb-masonry-item :itemStyle="{'width': '25%', 'padding': '10px'}">
                        <mdb-card>
                            ...
                            <mdb-card-body>
                                ...
                                <mdb-card-text>With supporting text below as a natural lead-in to additional content.
                                </mdb-card-text>
