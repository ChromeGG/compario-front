            ...
            <mdb-row>
                <mdb-col>
                    <select class="browser-default custom-select" @change="getSelectValue($event)">
                        <option :key="attentionSeekers.indexOf(entry)" v-for="entry in attentionSeekers"
                                :value="entry.value">{{entry.text}}
                        </option>
                    </select>
                    <select class="browser-default custom-select" @change="getSelectValue($event)">
                        <option :key="bouncingEntrances.indexOf(entry)" v-for="entry in bouncingEntrances"
                                :value="entry.value">{{entry.text}}
                        </option>
                    </select>
                    <select class="browser-default custom-select" @change="getSelectValue($event)">
                        <option :key="bouncingExits.indexOf(entry)" v-for="entry in bouncingExits" :value="entry.value">
                            {{entry.text}}
                        </option>
                    </select>
                    <select class="browser-default custom-select" @change="getSelectValue($event)">
                        <option :key="fadingEntrances.indexOf(entry)" v-for="entry in fadingEntrances"
                                :value="entry.value">{{entry.text}}
                        </option>
                    </select>
                    <select class="browser-default custom-select" @change="getSelectValue($event)">
                        <option :key="fadingExits.indexOf(entry)" v-for="entry in fadingExits" :value="entry.value">
                            {{entry.text}}
                        </option>
                    </select>
                    <select class="browser-default custom-select" @change="getSelectValue($event)">
                        <option :key="flippers.indexOf(entry)" v-for="entry in flippers" :value="entry.value">
                            {{entry.text}}
                        </option>
                    </select>
                    <select class="browser-default custom-select" @change="getSelectValue($event)">
                        <option :key="lightspeed.indexOf(entry)" v-for="entry in lightspeed" :value="entry.value">
                            {{entry.text}}
                        </option>
                    </select>
                </mdb-col>
                <mdb-col>
                    ...
                    <select class="browser-default custom-select" @change="getSelectValue($event)">
                        <option :key="rotatingEntrances.indexOf(entry)" v-for="entry in rotatingEntrances"
                                :value="entry.value">{{entry.text}}
                        </option>
                    </select>
                    <select class="browser-default custom-select" @change="getSelectValue($event)">
                        <option :key="rotatingExits.indexOf(entry)" v-for="entry in rotatingExits" :value="entry.value">
                            {{entry.text}}
                        </option>
                    </select>
                    <select class="browser-default custom-select" @change="getSelectValue($event)">
                        <option :key="slidingEntrances.indexOf(entry)" v-for="entry in slidingEntrances"
                                :value="entry.value">{{entry.text}}
                        </option>
                    </select>
                    <select class="browser-default custom-select" @change="getSelectValue($event)">
                        <option :key="slidingExits.indexOf(entry)" v-for="entry in slidingExits" :value="entry.value">
                            {{entry.text}}
                        </option>
                    </select>
                    <select class="browser-default custom-select" @change="getSelectValue($event)">
                        <option :key="zoomEntrances.indexOf(entry)" v-for="entry in zoomEntrances" :value="entry.value">
                            {{entry.text}}
                        </option>
                    </select>
                    <select class="browser-default custom-select" @change="getSelectValue($event)">
                        <option :key="zoomExits.indexOf(entry)" v-for="entry in zoomExits" :value="entry.value">
                            {{entry.text}}
                        </option>
                    </select>
                    <select class="browser-default custom-select" @change="getSelectValue($event)">
                        <option :key="specials.indexOf(entry)" v-for="entry in specials" :value="entry.value">
                            {{entry.text}}
                        </option>
                    </select>
                </mdb-col>
...
<script>
    import {animateOnScroll, mdbCol, mdbContainer, mdbIcon, mdbRow} from "mdbvue";
