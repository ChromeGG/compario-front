<template>
    <mdb-container class="mt-5">
        <mdb-row class="mt-5 align-items-center justify-content-start">
            ...
            <a href="https://mdbootstrap.com/docs/vue/forms/input-group/?utm_source=DemoApp&utm_medium=MDBVueFree"
               waves-fixed class="border grey-text px-2 border-light rounded ml-2" target="_blank">
        ...
        <mdb-row>
            <mdb-col md="6">
                ...
                <section class="preview">
                    ...
                    <mdb-input basic class="mb-3" ariaLabel="Example text with button addon"
                    ...
                    <mdb-input basic class="mb-3" ariaLabel="Example text with button addon"
                               ariaDescribedBy="button-addon3" prependSlotID="button-addon3">
                        <mdb-btn outline="secondary" size="md" group slot="prepend">button</mdb-btn>
                        <mdb-btn outline="secondary" size="md" group slot="prepend">button</mdb-btn>
                    </mdb-input>

                    <mdb-input basic class="mb-3" placeholder="Recipient's username"
                               ariaLabel="Recipient's username with two button addons" ariaDescribedBy="button-addon4"
                               appendSlotID="button-addon4">
            ...
            <mdb-col md="6">
                <section class="preview">
                    ...
                    <mdb-input class="mt-0 mb-3" ariaLabel="Example text with button addon"
                               ariaDescribedBy="button-addon1">
                    ...
                    <mdb-input class="mt-0 mb-3" placeholder="Recipient's username"
                               ariaLabel="Recipient's username with two button addons" ariaDescribedBy="button-addon4"
                               appendSlotID="button-addon4">
                ...
                <section class="preview">
                    ...
                    <mdb-input basic class="mb-3" ariaLabel="Example text with button addon"
                        ...
                        <mdb-dropdown slot="prepend">
                            <mdb-dropdown-toggle color="primary" size="md" slot="toggle" class="z-depth-0">dropdown
                            </mdb-dropdown-toggle>
                            <mdb-dropdown-menu>
                    ...
                    <mdb-input basic class="mb-3" ariaLabel="Example text with button addon"
                        ...
                        <mdb-dropdown slot="append">
                            <mdb-dropdown-toggle color="default" size="md" slot="toggle" class="z-depth-0">dropdown
                            </mdb-dropdown-toggle>
            ...
            <mdb-col md="12">
                ...
                <section class="preview">
                    ...
                    <mdb-input basic class="mb-3" ariaLabel="Example text with button addon"
                        ...
                        <mdb-dropdown slot="prepend">
                            <mdb-dropdown-toggle slot="toggle" outline="primary" class="z-depth-0 px-2"
                                                 size="md"></mdb-dropdown-toggle>
                            <mdb-dropdown-menu>
                                <mdb-dropdown-item>Action</mdb-dropdown-item>
                                <mdb-dropdown-item>Another action</mdb-dropdown-item>
                                <mdb-dropdown-item>Something else here</mdb-dropdown-item>
                    ...
                    <mdb-input basic class="mb-3" ariaLabel="Example text with button addon"
                        ...
                        <mdb-dropdown slot="append">
                            <mdb-dropdown-toggle slot="toggle" outline="info" class="z-depth-0 px-2"
                                                 size="md"></mdb-dropdown-toggle>
                            <mdb-dropdown-menu>
                                <mdb-dropdown-item>Action</mdb-dropdown-item>
                                <mdb-dropdown-item>Another action</mdb-dropdown-item>
            ...
            <mdb-col md="12">
                <section class="preview">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select class="browser-default custom-select" id="inputGroupSelect03"
        ...
        <mdb-row>
            <mdb-col md="12">
                <section class="preview">
                    ...
                    <mdb-input basic placeholder="Username" class="mb-3 mt-0 md-form form-sm form-1"
                               inputClass="amber-border">
                    ...
                    <mdb-input basic class="mb-2 mt-0 md-form form-2 form-sm" inputClass="lime-border"
                    ...
                    <mdb-input basic placeholder="Recipient's Username" class="mb-3 md-form form-sm form-3"
                               ariaDescribedBy="basic-addon12" inputClass="purple-border">
                        <span class="input-group-text purple lighten-3 black-text" slot="append" id="basic-addon12">@example.com</span>
                    </mdb-input>

                    <label for="vanity">Your vanity URL</label>
                    <mdb-input basic id="vanity" class="mb-3 mt-0 md-form form-sm form-1"
                               ariaDescribedBy="basic-addon33" inputClass="blue-border">
