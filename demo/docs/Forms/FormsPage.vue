<template>
    <mdb-container>
        <mdb-row class="mt-5 align-items-center justify-content-start">
            ...
            <a href="https://mdbootstrap.com/docs/vue/forms/basic/?utm_source=DemoApp&utm_medium=MDBVueFree" waves-fixed
                                ...
                                <mdb-card-body>
                                    <mdb-row>
                                        <mdb-col>
                                            ...
                                            <mdb-input :min="2" :max="10" icon="edit" far type="number" label="guests"
                                                       v-model="guests"/>
                                ...
                                <mdb-card-body>
                                    <mdb-row class="mb-4 pb-3">
                                        <mdb-col>
                                            ...
                                            <mdb-input outline :min="2" :max="10" icon="edit" type="number"
                                                       label="guests"/>
                                            <mdb-input type="textarea" outline :rows="4" label="special requests"
                                                       icon="comment"/>
                                        </mdb-col>
                                    </mdb-row>
                                </mdb-card-body>
                            ...
                            <form>
                                ...
                                <div class="text-center">
                                    <mdb-btn outline="info">Send
                                        <mdb-icon icon="paper-plane-o" class="ml-1"/>
                                    </mdb-btn>
                                </div>
                            </form>
                        </mdb-col>
                    ...
                    <mdb-row>
                            ...
                            <form>
                                ...
                                <div class="grey-text">
                                    <mdb-input label="Your name" icon="user" group type="text" validate error="wrong"
                                               success="right"/>
                                    <mdb-input label="Your email" icon="envelope" group type="email" validate
                                               error="wrong" success="right"/>
                                    <mdb-input label="Subject" icon="tag" group type="text" validate error="wrong"
                                               success="right"/>
                        ...
                        <mdb-col md="6">
                            <form>
                                ...
                                <textarea type="text" id="defaultFormContactMessageEx" class="form-control"
                                          rows="3"></textarea>
                                <div class="text-center mt-4">
                                ...
                                <mdb-card-body>
                                    <form>
                                        ...
                                        <div class="grey-text">
                                            ...
                                            <mdb-input label="Your email" icon="envelope" group type="email" validate
                                                       error="wrong" success="right"/>
                                            <mdb-input label="Confirm your email" icon="exclamation-triangle" group
                                                       type="text" validate error="wrong" success="right"/>
                                            <mdb-input label="Your password" icon="lock" group type="password"
                                                       validate/>
                                        </div>
                            ...
                            <div class="card mx-xl-5">
                                <div class="card-body">
                                    <form>
                                        ...
                                        <label htmlFor="defaultFormCardNameEx" class="grey-text font-weight-light">Your
                                            name</label>
                                        <input type="text" id="defaultFormCardNameEx" class="form-control"/>
                                        <br/>
                                        <label htmlFor="defaultFormCardEmailEx" class="grey-text font-weight-light">Your
                                            email</label>
                        ...
                        <mdb-col size="12" class="text-center mb-5">
                            ...
                            <mdb-modal :show="showModal" @close="showModal = false" cascade class="text-left">
                                ...
                                <mdb-modal-body class="grey-text">
                                    <mdb-input size="sm" label="Your name" icon="user" group type="text" validate
                                               error="wrong" success="right"/>
                                    <mdb-input size="sm" label="Your email" icon="envelope" group type="email" validate
                                               error="wrong" success="right"/>
                                    <mdb-input size="sm" label="Subject" icon="tag" group type="text" validate
                                               error="wrong" success="right"/>
