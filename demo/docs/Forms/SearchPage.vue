<template>
    <mdb-container>
        <mdb-row class="mt-5 align-items-center justify-content-start">
            ...
            <a href="https://mdbootstrap.com/docs/vue/components/demo/search/?utm_source=DemoApp&utm_medium=MDBVueFree"
...
<script>
    import {mdbCol, mdbContainer, mdbFormInline, mdbIcon, mdbInput, mdbRow} from 'mdbvue';
