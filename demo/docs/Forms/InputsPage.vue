<template>
    <mdb-container>
        <mdb-row class="mt-5 align-items-center justify-content-start">
            ...
            <a href="https://mdbootstrap.com/docs/vue/forms/inputs/?utm_source=DemoApp&utm_medium=MDBVueFree"
            ...
            <mdb-col sm="6">
                <section class="demo-section">
                    ...
                    <section>
                        ...
                        <mdb-input m="t5" type="text" label="Random example" :value="test" @input="handleInput"
                                   @change="handleInput"/>
            ...
            <section>
                <mdb-row>
                    <mdb-col sm="6">
                        ...
                        <mdb-input type="email" label="E-mail address" icon="envelope"
                                   small="We'll never share your email with anyone." outline/>
            ...
            <mdb-col sm="6">
                <section class="demo-section">
                    ...
                    <section>
                        ...
                        <mdb-input type="number" :min="0" label="step 0.2" :max="10" :step="0.2"
                    ...
                    <div class="form-row align-items-center">
                        ...
                        <div class="col-auto">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input type="text" class="form-control py-0" id="inlineFormInputGroup"
...
<script>
    import {mdbBtn, mdbCol, mdbContainer, mdbIcon, mdbInput, mdbRow, mdbTextarea} from "mdbvue";
