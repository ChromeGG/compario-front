<template>
    <mdb-container class="mt-5">
        <mdb-row class="mt-5 align-items-center justify-content-start">
            ...
            <a href="https://mdbootstrap.com/plugins/vue/iframe/?utm_source=DemoApp&utm_medium=MDBVueFree" waves-fixed
        ...
        <mdb-row>
            <mdb-col lg="4" md="12">
                ...
                <div class="embed-responsive embed-responsive-16by9 z-depth-1">
                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/fa3Iczgh8Ok"
