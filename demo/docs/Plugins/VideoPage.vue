<template>
    <mdb-container class="text-center mt-5">
        <mdb-row class="mt-5">
            ...
            <a href="https://mdbootstrap.com/plugins/vue/video/?utm_source=DemoApp&utm_medium=MDBVueFree" waves-fixed
...
<script>
    import {mdbCarousel, mdbCol, mdbContainer, mdbIcon, mdbRow} from 'mdbvue';
