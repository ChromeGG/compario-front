<template>
    <mdb-container>
        <mdb-row class="mt-5 align-items-center justify-content-start">
            ...
            <a href="https://mdbootstrap.com/plugins/vue/blog-components/?utm_source=DemoApp&utm_medium=MDBVueFree"
            ...
            <section>
                <mdb-card-header class="border-0 font-weight-bold d-flex justify-content-between">
                    ...
                    <ul class="list-unstyled list-inline mb-0">
                        <li class="list-inline-item"><a href="" class="mr-3">
                            <mdb-icon icon="envelope" class="mr-1"/>
                            Send message</a></li>
                        <li class="list-inline-item"><a href="" class="mr-3">
                            <mdb-icon icon="user" class="mr-1"/>
                            See profile</a></li>
                        <li class="list-inline-item"><a href="" class="mr-3">
                            <mdb-icon icon="rss" class="mr-1"/>
                            Follow</a></li>
                    </ul>
                </mdb-card-header>
                <mdb-media class="mt-4 px-1">
                    <img class="card-img-100 d-flex z-depth-1 mr-3"
                         src="https://mdbootstrap.com/img/Photos/Avatars/img%20(8).jpg" alt="Generic placeholder image">
                    <mdb-media-body>
                        <h5 class="font-weight-bold mt-0">
                            <a href="">Danny Newman</a>
                        </h5>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quod consectetur accusamus velit
                        nostrum et magnam.
                    </mdb-media-body>
                </mdb-media>
            </section>
        ...
        <section class="demo-section">
            ...
            <section>
                <mdb-card-header class="border-0 font-weight-bold d-flex justify-content-between">
                    <p class="mr-4 mb-0">About the author</p>
                    <ul class="list-unstyled list-inline mb-0">
                        <li class="list-inline-item"><a href="" class="text-default mr-3">
                            <mdb-icon icon="envelope" class="mr-1"/>
                            Send message</a></li>
                        <li class="list-inline-item"><a href="" class="text-default mr-3">
                            <mdb-icon icon="user" class="mr-1"/>
                        ...
                        <ul class="list-unstyled list-inline mb-2 pt-1">
                            <li class="list-inline-item">
                                <a class="grey-text mr-1">
                                    <mdb-icon fab icon="facebook" size="lg"/>
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a class="grey-text mr-1">
                            ...
                            <li class="list-inline-item">
                                <a class="grey-text mr-1">
                                    <mdb-icon fab icon="google-plus" size="lg"/>
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a class="grey-text mr-1">
                                    <mdb-icon fab icon="linkedin" size="lg"/>
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a class="grey-text mr-1">
        ...
        <section class="demo-section">
            ...
            <section>
                <mdb-card-header class="border-0 font-weight-bold d-flex justify-content-between">4 comments
                </mdb-card-header>
        ...
        <section class="demo-section">
            ...
            <section>
                <mdb-card-header class="border-0 font-weight-bold d-flex justify-content-between">Leave a reply
                </mdb-card-header>
        ...
        <section class="demo-section">
            ...
            <section>
                <mdb-card-header class="border-0 font-weight-bold d-flex justify-content-between">Leave a reply (logged
                    in user)
                </mdb-card-header>
                <div class="d-md-flex flex-md-fill mt-4 px-1">
                    <div class="d-flex justify-content-center mr-md-5">
                        <img class="card-img-100 z-depth-1 mb-4"
