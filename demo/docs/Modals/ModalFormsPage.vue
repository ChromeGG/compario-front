<template>
    <mdb-container>
        ...
        <mdb-btn rounded color="default" @click.native="login=true">launch login modal
        ...
        <mdb-btn rounded color="default" @click.native="register = true">launch register modal
            <mdb-icon icon="eye" class="ml-1"/>
        </mdb-btn>
        ...
        <mdb-btn rounded color="default" @click.native="subs = true">launch subscrition modal
            <mdb-icon icon="eye" class="ml-1"/>
        </mdb-btn>
        ...
        <mdb-btn rounded color="default" @click.native="contact = true">launch contact form modal
            <mdb-icon icon="eye" class="ml-1"/>
        </mdb-btn>
        ...
        <mdb-btn rounded color="default" @click.native="header = true">launch header form modal
            <mdb-icon icon="eye" class="ml-1"/>
        </mdb-btn>
