<template>
    <mdb-container>
        <mdb-row class="mt-5 align-items-center justify-content-start">
            ...
            <a href="https://mdbootstrap.com/docs/vue/modals/basic/?utm_source=DemoApp&utm_medium=MDBVueFree"
        ...
        <h4>Show</h4>
        <mdb-btn rounded color="default" @click="show = true">launch success modal
        ...
        <mdb-modal :show="show" @show="handleShow" @close="show = false" success>
            ...
            <mdb-modal-body class="text-center">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Impedit iusto nulla aperiam blanditiis ad
                    consequatur in dolores culpa, dignissimos, eius non possimus fugiat. Esse ratione fuga, enim, ab
                    officiis totam.</p>
            </mdb-modal-body>
            <mdb-modal-footer center>
                <mdb-btn color="success" @click="show = false">Get it now
        ...
        <mdb-btn rounded color="default" @click="shown = true">launch info modal
            <mdb-icon icon="eye" class="ml-1"/>
        </mdb-btn>
        <mdb-modal :show="shown" @shown="handleShown" @close="shown = false" info>
            ...
            <mdb-modal-body>
                <img src="https://mdbootstrap.com/wp-content/uploads/2016/11/admin-dashboard-bootstrap.jpg" alt="modal"
                     class="img-fluid"/>
                <p class="text-center">
            ...
            <mdb-modal-footer center>
                <mdb-btn color="info" @click="shown = false">Get it now
                    <mdb-icon icon="gem" far class="ml-1" color="white"/>
                </mdb-btn>
        ...
        <mdb-btn rounded color="default" @click="hide = true">launch danger modal
            <mdb-icon icon="eye" class="ml-1"/>
        </mdb-btn>
        <mdb-container @hide="handleHide">
            <mdb-modal :show="hide" @close="hide = false" danger>
                ...
                <mdb-modal-footer center>
                    <mdb-btn color="danger" @click="hide = false">Get it now
                        <mdb-icon icon="gem" far class="ml-1" color="white"/>
                    </mdb-btn>
        ...
        <mdb-btn rounded color="default" @click="hidden=true">launch warning modal
            <mdb-icon icon="eye" class="ml-1"/>
        </mdb-btn>
        <mdb-container @hidden="handleHidden">
            <mdb-modal :show="hidden" @close="hidden = false" warning>
                ...
                <mdb-modal-body>
                    <mdb-row>
                        <mdb-col col="3" class="text-center">
                            <img src="https://mdbootstrap.com/img/Photos/Avatars/img%20(1).jpg" alt="Jane, Consultant"
                        ...
                        <mdb-col col="9">
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fuga, molestiae provident
                                temporibus sunt earum.</p>
                            <p class="card-text"><strong>Lorem ipsum dolor sit amet, consectetur adipisicing
                                elit.</strong></p>
                        </mdb-col>
                    </mdb-row>
                </mdb-modal-body>
                <mdb-modal-footer center>
                    <mdb-btn color="warning" @click="hidden = false">Get it now
                        <mdb-icon icon="gem" far class="ml-1" color="white"/>
                    </mdb-btn>
