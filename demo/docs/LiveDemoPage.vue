    ...
    <mdb-container>
            ...
            <mdb-navbar color="default" dark class="mt-4" name="Navbar" href="#">
                <mdb-navbar-toggler>
                    <mdb-navbar-nav>
                        ...
                        <!-- mdbDropdown -->
                        <mdb-dropdown tag="li" class="nav-item">
                            <mdb-dropdown-toggle slot="toggle" tag="a" navLink color="default" waves-fixed>Dropdown
                            </mdb-dropdown-toggle>
                    ...
                    <mdb-navbar-nav right>
                        ...
                        <mdb-dropdown tag="li" class="nav-item">
                            <mdb-dropdown-toggle slot="toggle" tag="a" navLink color="default" waves-fixed>
            ...
            <mdb-navbar color="danger" dark class="mt-4" name="Navbar" href="#">
                <mdb-navbar-toggler>
                    ...
                    <mdb-navbar-nav right>
                        ...
                        <mdb-nav-item href="#">
                            <mdb-icon icon="cog"></mdb-icon>
                            Settings
                        </mdb-nav-item>
                        <mdb-dropdown tag="li" class="nav-item">
                            <mdb-dropdown-toggle slot="toggle" tag="a" navLink color="danger" waves-fixed>
                                <mdb-icon icon="user"></mdb-icon>
                                Profile
                            </mdb-dropdown-toggle>
            ...
            <mdb-row>
                <mdb-col col="12" sm="4">
                    <mdb-list-group>
                        ...
                        <mdb-list-group-item :action="true">Messages
                            <mdb-badge :pill="true">12</mdb-badge>
                        </mdb-list-group-item>
                ...
                <mdb-col col="12" sm="4">
                    <mdb-list-group>
                        ...
                        <mdb-list-group-item :action="true">Sell Products</mdb-list-group-item>
                        <mdb-list-group-item :action="true">Settings
                            <mdb-badge :pill="true" color="indigo">12</mdb-badge>
                        </mdb-list-group-item>
                        <mdb-list-group-item :disabled="true">Can't Touch This</mdb-list-group-item>
                    </mdb-list-group>
                </mdb-col>
                <mdb-col col="12" sm="4">
                    <mdb-list-group>
                        <mdb-list-group-item :action="true" class="special-color text-white">Main Menu
                        </mdb-list-group-item>
                        <mdb-list-group-item :action="true">Messages</mdb-list-group-item>
                        <mdb-list-group-item :action="true">Sell Products
                            <mdb-badge :pill="true" color="special-color">12</mdb-badge>
                        </mdb-list-group-item>
                        <mdb-list-group-item :action="true">Settings</mdb-list-group-item>
                        <mdb-list-group-item :disabled="true">Can't Touch This</mdb-list-group-item>
                    </mdb-list-group>
        ...
        <section>
            ...
            <mdb-row>
                ...
                <mdb-col col="12" sm="6">
                    <mdb-view overlay="blue-strong" src="https://mdbootstrap.com/img/Photos/Others/nature-sm.jpg"
                              alt="view">
                        <mdb-mask flex-center waves overlay="blue-strong"
                                  text="overlay = &quot;blue-strong&quot; waves"></mdb-mask>
                    </mdb-view>
                </mdb-col>
                <mdb-col col="12" sm="6">
                    <mdb-view src="https://mdbootstrap.com/img/Photos/Others/nature-sm.jpg" alt="view">
            ...
            <mdb-row>
                <mdb-col md="6">
                    <mdb-card align="center">
                        ...
                        <mdb-card-footer color="danger-color"><p class="mb-0">Please enjoy this footer</p>
                        </mdb-card-footer>
                    </mdb-card>
                </mdb-col>
                <mdb-col md="6">
